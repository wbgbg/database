angular.module('database')
    .controller('PatientBookDialogCtrl', ['$scope', '$routeParams', '$mdDialog', '$mdDateLocale', 'doctorUserService',
        function($scope, $routeParams, $mdDialog, $mdDateLocale, doctorUserService) {
            ...
            $scope.$watch('booking.department',function(department) {
                console.log(department);
                doctorUserService.getDoctorbyDepartment(department);
                $scope.$on('getDoctorbyDepartment', function(event, flag) {
                    if (flag) {
                        console.log(doctorUserService.availableDoctor());
                        $scope.optionalDoctor = doctorUserService.availableDoctor();
                    }
                });
            });
            $scope.hide = function() {
